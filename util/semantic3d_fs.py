...
class semantic3d(semantic3d_base):
    """
    The semantic3d dataset class used for backbone pretraining.
    """
...
class semantic3d_FS(semantic3d_base):
    """
    The semantic3d dataset class used for few-shot learning.
    """
...
class semantic3d_FSForVIS(semantic3d_FS):
    """
    The semantic3d dataset class used for visulizaling the few-shot results.
    """
...
class semantic3d_FS_TEST(Dataset):
    def __init__(
        self,
        split="val",
        data_root="trainval",
